...
client = mqtt.Client(client_id="Sender2", protocol=mqtt.MQTTv311)
...
try:
    ...
    client.subscribe("topic/p2-lasertag", qos=0)
    print("📩 Subscribed to: topic/p2-lasertag")
    ...
    while True:
        ...
        client.publish("topic/p2-lasertag", message)
