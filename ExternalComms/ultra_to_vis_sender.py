...
MQTT_USER = "jzzkaznp:jzzkaznp"  # ✅ Remove the colon from the username
...
try:
    ...
    client.subscribe("topic/lasertag", qos=0)
    print("📩 Subscribed to: topic/lasertag")

    # ✅ Publish a test message
    client.publish("topic/lasertag", "RELOAD")
    print("📤 Sent MQTT Message: RELOAD")
